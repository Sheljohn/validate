...
Property.prototype = {
  ...
  /**
  * Check minimum size of the property
  *
  * @param {number} [mnm]
  * @param {String} [msg]
  * @return {Property}
  ...
  */
  ...
  min: function (mnm, msg) {
    return this.use(min(mnm), msg);
  },

  /**
  * Check maximum size of the property
  *
  * @param {number} [mx]
  * @param {String} [msg]
  * @return {Property}
  ...
  return function (value) {
    ...
    switch (typeOf(value)) {
      ...
      case 'string':
        return !!value;
      case 'array':
        return !strict || value.length > 0;
      case 'object':
        // See: http://stackoverflow.com/a/4994244/472610
        return !strict || Object.getOwnPropertyNames(value).length > 0;
      case 'date':
        // See: http://stackoverflow.com/a/1353711/472610
        return !strict || !isNaN(value.getTime());
      default:
        return false;
    }
  }
...
function min (bnd) {
  return function (value) {
    return value == null || (typeOf(value) == 'number') ? (value > bnd) : (value.length > bnd);
  }
}
